...
export module helper {
    ...
    export class MathHelper {
        ...
        public static binomial(n: number, k: number) {
            let coeff = 1;
        ...
        public static GetNumberXWithNDicesWithDFaces(wantedNumber: number, diceNumber: number, FacesNumber: number) {
            let turnsNb: number = Math.floor((wantedNumber - diceNumber) / FacesNumber);
            let result: number = 0;
            for (let turnNb = 0; turnNb <= turnsNb; turnNb++) {
