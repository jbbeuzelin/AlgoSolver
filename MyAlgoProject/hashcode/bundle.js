...
var Hashcode = (function (_super) {
    __extends(Hashcode, _super);
    function Hashcode(fileName) {
        var _this = _super.call(this, fileName) || this;
        var testCases = lodash_1.parseInt(_this.reader.nextLine());
        console.time('Time tacken by solver');
        lodash_1.times(testCases, function (i) { return _this.solveCase(i); });
        console.timeEnd('Time tacken by solver');
        _this.writer.writeFile();
        return _this;
    }
    Hashcode.prototype.solveCase = function (testCase) {
